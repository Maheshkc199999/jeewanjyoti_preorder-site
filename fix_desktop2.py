...
# Find the line with "CURRENT USER" and replace the section
new_section = '''                    <div className={`p-3 border-b ${
...
# Find and replace lines 516-527 (0-indexed: 515-526)
lines[515:527] = [new_section]

# Write back
with open(r'c:\jeewanjyoti-care\src\pages\Dashboard.jsx', 'w', encoding='utf-8') as f:
    f.writelines(lines)

print("Desktop dropdown MY DATA button added!")
