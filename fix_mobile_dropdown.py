...
# Find and replace the mobile dropdown section
# We'll insert the "MY DATA" section right after the dropdown div opens

old_pattern = r"(\{showUserDropdown && \(\s+<div className=\{`rounded-xl border shadow-lg animate-in slide-in-from-top duration-200 \$\{\s+darkMode\s+\? 'bg-gray-700 border-gray-600'\s+: 'bg-white border-gray-200'\s+\}`\}>\s+)(\{mappedUsers\.length > 0 &&)"

new_content = r'''\1{/* Current User Option */}
...
print("Mobile dropdown fix applied successfully!")
